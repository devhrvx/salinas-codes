...
export default async function handler(req, res) {
  ...
  const prodInfo = {
    ...
    specifications: 'The product is stored on a plastic spray bottle that is recyclable (height: 20cm, width 7cm, and volume: 500ml)',
  ...
  const prodFormatted = `Product information that you need to know:
    ...
    Physical specifications: ${prodInfo.specifications},
